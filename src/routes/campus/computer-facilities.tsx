...
export const Route = createFileRoute("/campus/computer-facilities")({
  head: () => ({
    meta: [
      { title: "Computer Facilities & IT Infrastructure — SDIT Mangaluru" },
      {
        name: "description",
        content:
          "Official IT infrastructure, computer laboratories, high-speed internet, campus Wi-Fi, and Edusat distance learning at Shree Devi Institute of Technology (SDIT), Kenjar.",
      },
      {
        property: "og:title",
        content: "Computer Facilities & IT Infrastructure — SDIT Mangaluru",
      },
      {
        property: "og:description",
        content:
          "High-performance networked labs, campus-wide Wi-Fi, and modern digital learning tools at SDIT Mangaluru.",
      },
    ],
  }),
  component: CampusComputerFacilitiesPage,
});

function CampusComputerFacilitiesPage() {
  const facility = campusFacilities.find((f) => f.id === "computer-facilities")!;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main>
        <CampusPageHeader
          currentPage="computer-facilities"
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                ...
                <div className="flex items-start justify-between gap-4 border-b border-border/60 pb-5">
                  <div className="flex items-center gap-3">
                    <span className="grid size-10 place-items-center rounded-xl bg-surface text-navy">
                      {idx === 0 && <Server className="size-5" />}
                      {idx === 1 && <Wifi className="size-5" />}
                      {idx === 2 && <Radio className="size-5" />}
                      {idx === 3 && <Monitor className="size-5" />}
                    </span>
                    <div>
          ...
          <div className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-border pt-8">
            ...
            >
              ...
              Previous: Department Laboratories
            </Link>
