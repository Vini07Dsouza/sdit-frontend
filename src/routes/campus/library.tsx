...
export const Route = createFileRoute("/campus/library")({
  head: () => ({
    meta: [
      { title: "Central Library — Shree Devi Institute of Technology (SDIT)" },
      {
        name: "description",
        content:
          "Official Central Library & Digital Resource Centre at Shree Devi Institute of Technology (SDIT), Kenjar, Mangaluru. Over 26,759 books, 150+ journals, open-access catalog, and digital e-resources.",
      },
      {
        property: "og:title",
        content: "Central Library — Shree Devi Institute of Technology (SDIT)",
      },
      {
        property: "og:description",
        content:
          "Explore the SDIT Central Library: 26,759+ volumes, 2,684+ engineering titles, digital library stations, and spacious reading room.",
      },
    ],
  }),
  component: CampusLibraryPage,
});

function CampusLibraryPage() {
  const facility = campusFacilities.find((f) => f.id === "library")!;
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
                ...
                <div className="flex items-start justify-between gap-4 border-b border-border/60 pb-5">
                  <div className="flex items-center gap-3">
                    <span className="grid size-10 place-items-center rounded-xl bg-surface text-navy">
                      {idx === 0 && <BookOpen className="size-5" />}
                      {idx === 1 && <Monitor className="size-5" />}
                      {idx === 2 && <Newspaper className="size-5" />}
                      {idx === 3 && <Clock className="size-5" />}
                    </span>
                    <div>
          ...
          {/* Bottom Navigation & Next Facility */}
          <div className="mt-12 flex flex-wrap items-center justify-between gap-4 border-t border-border pt-8">
            ...
            >
              Next: Departmental Laboratories
