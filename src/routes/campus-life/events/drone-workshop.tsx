...
export const Route = createFileRoute("/campus-life/events/drone-workshop")({
  head: () => ({
    meta: [
      { title: "Workshop on Drone Industry Ready — SDIT Events" },
      {
        name: "description",
        content:
          "Official workshop on Drone Industry Ready: Skills, Careers & Future Opportunities organized by SDIT Aeronautical Engineering Department in collaboration with ZenVed.",
      },
      {
        property: "og:title",
        content: "Workshop on Drone Industry Ready — SDIT Events",
      },
    ],
  }),
  component: DroneWorkshopPage,
});

export function DroneWorkshopPage() {
  const event = sditEvents.find((e) => e.slug === "drone-workshop")!;
      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <nav aria-label="Breadcrumb" className="mb-6 text-xs text-muted-foreground">
          <ol className="flex items-center gap-2">
            ...
            <li>/</li>
            <li className="font-semibold text-foreground">Drone Industry Workshop</li>
          </ol>
        </nav>
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-8">
            <div className="rounded-2xl border border-border bg-card p-6 shadow-soft sm:p-8">
              <h2 className="text-xl font-bold text-card-foreground">Event Overview</h2>
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-soft sm:p-8 space-y-6">
            ...
            <div className="space-y-4 text-xs">
              <div>
                <span className="font-semibold text-muted-foreground uppercase">Date</span>
