...
export const Route = createFileRoute("/campus-life/events/surabhi")({
  head: () => ({
    meta: [
      { title: "Surabhi Fest — SDIT Events" },
      {
        name: "description",
        content:
          "Official Surabhi intra-college technical and cultural festival at SDIT Mangaluru.",
      },
      {
        property: "og:title",
        content: "Surabhi Fest — SDIT Events",
      },
    ],
  }),
  component: SurabhiPage,
});

export function SurabhiPage() {
  const event = sditEvents.find((e) => e.slug === "surabhi")!;
      ...
      <main className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <nav aria-label="Breadcrumb" className="mb-6 text-xs text-muted-foreground">
          <ol className="flex items-center gap-2">
            ...
            <li>/</li>
            <li className="font-semibold text-foreground">Surabhi Fest</li>
          </ol>
        </nav>
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-3">
          <div className="lg:col-span-2 space-y-8">
            <div className="rounded-2xl border border-border bg-card p-6 shadow-soft sm:p-8">
              ...
              <h3 className="mt-8 text-lg font-bold text-card-foreground">Event Highlights</h3>
