  ...
  return (
    <div className="rounded-2xl border border-[#C4B5FD]/25 bg-[#191724] p-5 shadow-xl shadow-[#0D0B18]/60 sm:p-7 text-[#FAF9F7]">
      <div className="flex items-start gap-3.5 sm:gap-4">
        <div
          aria-hidden="true"
          className="relative grid size-12 shrink-0 place-items-center overflow-hidden rounded-2xl bg-[#0D0B18] ring-1 ring-[#C4B5FD]/45 shadow-[0_0_20px_-4px_rgba(255,107,74,0.35)]"
        >
          <img
